...
REQUESTS_DIR   = HYPO_ROOT / "dataset" / "move_eval_gpt4o_requests_dense"
...
OUT_JSON   = HYPO_ROOT / "dataset" / "contextvqa_move_eval_gpt4o_dense.json"
BATCH_IDS_FILE = HYPO_ROOT / "dataset" / "move_eval_gpt4o_batch_ids_dense.json"
