...
EVAL_JSON  = HYPO_ROOT / "dataset" / "contextvqa_move_eval_labelled.json"
REQUESTS_DIR   = HYPO_ROOT / "dataset" / "move_eval_gpt4o_requests_labelled"
...
MODEL = "gpt-4o"
REQUESTS_PER_FILE = 50   # 50 reqs × ~1,800 tokens ≈ 45k tokens, safely under 90k org limit
...
OUT_JSON   = HYPO_ROOT / "dataset" / "contextvqa_move_eval_gpt4o_labelled_v2.json"
BATCH_IDS_FILE = HYPO_ROOT / "dataset" / "move_eval_gpt4o_batch_ids_labelled_v2.json"
REQUESTS_DIR   = HYPO_ROOT / "dataset" / "move_eval_gpt4o_requests_labelled_v2"
