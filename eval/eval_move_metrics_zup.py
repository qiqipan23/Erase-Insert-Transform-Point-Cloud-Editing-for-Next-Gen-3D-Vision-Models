...
UP = np.array([0.0, 0.0, 1.0])  # Z = up (matches data + pipeline)
...
def load_scene_axes(scene_dir: Path,
    ...
    scene_center[2] = 0  # ignore Z (up) for horizontal axes
    ...
    for direction in ["Front", "Back", "Left", "Right"]:
        ...
        vec = c - scene_center
        vec[2] = 0  # project to horizontal plane (Z up)
    ...
    if "Front" in direction_vecs:
        ...
        axes["right"] = np.cross(direction_vecs["Front"], UP)
...
def relation_correct(moved_centroid: np.ndarray,
    ...
    if scene_axes and axis_key in scene_axes:
        ...
        fallback = {"right": 0, "left": 0, "front": 1, "back": 1, "up": 2, "down": 2}
